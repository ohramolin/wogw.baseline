...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentArea" runat="server">
	...
	<div class="contentPane">
		<div class="propertyItems">
			...
			<div class="propertyPane contentCatalogItemSelector">
				<div class="catalogItemSelector">
					<uc:CatalogItemSelector runat="server" id="catalogItemSelector"
						SelectType="<%# CatalogItemType.Sellable %>"
						MultipleSelect="true" />
				</div>
				<div class="propertyPaneFooter"></div>
			</div>
